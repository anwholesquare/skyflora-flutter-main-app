...
class AppConfig {
  ...
  static String app_name = "SkyFlora"; //this shows in the splash screen
  static String purchase_code = "f2e73814-ab00-43d7-ae39-ffba99e17414"; //enter your purchase code for the app from codecanyon
  ...
  static const DOMAIN_PATH = "skyflora.org"; //inside a folder
